...
2．1F～10Fの２投目と、必要に応じて10Fの3投目のスコアを記録します。その確認方法は、記録対象のフレームの累計スコアと前のフレームまでの累計スコアの差と、画像解析AIが記載した１投目のスコアの差から計算してください。1フレーム目は記録対象のフレームの累計スコアと画像解析AIが記載した１投目のスコアから計算してください。決して、記録する数値を直接見に行かないでください。
