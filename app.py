...
3. 最初のゲーム数: 一番上のゲームのスコア欄の上か左の数字。「1G」や「ゲーム1」や「GAME1」と記載されている。また、一日のゲーム数が多いとスコアシートが２枚目や３枚目になり、ゲーム1から始まらない場合があるため、しっかりとゲーム数を確認して。「1」などの数値のみを "start_game_num" に出力。
